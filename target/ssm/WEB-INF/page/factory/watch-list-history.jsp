...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="edit">驳回</a>
            <a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete" lay-event="delete">隔离</a>
        </script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${basePath}/town/resident/history/data.json',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'end_time',title: '结束时间', width: 200, sort:true,templet:'<div>{{layui.util.toDateString(d.end_time,"yyyy-MM-dd HH:mm:ss")}}</div>'},
                {title: '隔离天数', width: 150, sort:true,templet:function(d){
